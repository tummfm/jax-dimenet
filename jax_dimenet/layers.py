...
class EmbeddingBlock(hk.Module):
    ...
    Embeds edges by concatenating RBF embeddings with atom type embeddings of
    both connected atoms.
    """
    def __init__(self, embed_size, n_species, type_embed_size=None,
                 activation=nn.swish, init_kwargs=None, name='Embedding'):
    ...
    def __call__(self, rbf, species, idx_i, idx_j):
